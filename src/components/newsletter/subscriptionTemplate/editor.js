...
export const Editor = ({ langKey, updateContent, defaultContents = '' }) => {
    ...
    const containerId = `subscription-template-editor-${langKey}`;
    ...
    return (
        <div>
            {defaultContents.includes("{{confirmationUrl}}") ? '' :
                <Alert variant="danger">
                    It is mandatory to include an hiperlink with {"{{confirmationUrl}}"} string.
                </Alert>}
